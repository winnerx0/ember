  ...
  (
    ...
    React.useLayoutEffect(() => {
      if (open && triggerRef.current) {
        ...
        // For fixed positioning, we use viewport-relative coordinates from getBoundingClientRect()
    ...
    return ReactDOM.createPortal(
      <div
        ref={contentRef}
        className={cn(
          "fixed z-[100] mt-1 max-h-[300px] overflow-auto rounded-md border shadow-xl animate-in fade-in-0 zoom-in-95 text-foreground",
          className,
        )}
        style={{
          top: `${pos.top}px`,
